...
xscope = []
for row in rscope: 
    tscope.append(float(row[0])*1.E9 + 0.245 + 0.001)
...
fcaen = open('/home/tyler/DAQ/DAQ/pulse_100mV_100ns_0p5v/UNFILTERED/0@DT5730 #2-11-586_Data_pulse_100mV_100ns_0p5v.csv','r')
...
for row in rcaen: 
    ...
    xcaen = [(xi - 8142)*(95./795.)*(94.76/93.55)/4 - 4.33 for xi in xcaen]
